    ...
    <section className="py-20 bg-white-pure">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 fade-in-up">
          <span className="text-gold-primary font-body font-semibold text-lg">Artigos Jurídicos</span>
          ...
          <p className="text-gray-medium text-xl max-w-3xl mx-auto font-body">
            Mantenha-se atualizado com as principais mudanças na legislação e dicas jurídicas importantes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {blogPosts.map((post, index) => (
            <article key={index} className="card-premium overflow-hidden hover-lift fade-in-up">
              {/* Image */}
              ...
              <div className="p-6">
                ...
                <h3 className="font-display text-xl font-semibold text-dark-primary mb-3 hover:text-gold-primary transition-colors duration-300">
                  <a href="#" className="gold-underline">
                    {post.title}
                  </a>
                </h3>
